...
namespace Maxov.Otus.RestAndOdata.Controllers
{
    ...
    public class ChampionshipsV3Controller : ControllerBase
    {
        private readonly IChampionshipService _championatService;
        private readonly IMapper _mapper;

        public ChampionshipsV3Controller(IChampionshipService championshipService, IMapper mapper)
        {
        ...
        /// <remarks>
        ///     Sample request:
        ///     GET /api/footbal-manager/v3.0/championships/
        /// </remarks>
        ...
        public async Task<ChampionshipsContainerV3ViewModel> GetV3Async(CancellationToken cancellationToken = default)
        {
            var championships = await _championatService.GetAllAsync(cancellationToken);
            var container = _mapper.From(championships).AdaptToType<ChampionshipsContainerV3ViewModel>();
        ...
        /// <remarks>
        ///     Sample request:
        ///     GET /api/footbal-manager/v3.0/championships/:id
        /// </remarks>
        ...
        public async Task<ChampionshipViewModel> GetV3Async(int id, CancellationToken cancellationToken = default)
        {
        ...
        /// <remarks>
        ///     Sample request:
        ///     POST /api/footbal-manager/v3.0/championships/
        ///     {
        ...
        /// <response code="500">Внутренняя ошибка сервера</response>
        [HttpPost]
        public async Task CreateV3Async(ChampionshipCreateModel model, CancellationToken cancellationToken = default)
        {
